...
def refreshing_my_token():
    refresh_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTcyMTM5ODA4OSwiaWF0IjoxNzIxMzExNjg5LCJqdGkiOiJhZGExYWZjYzRmOTI0NTM5YmFjNDQ3ZDJmODJhYTU3NCIsInVzZXJfaWQiOjF9.myRkfOHcEA3Vvs3Yig38pE63IUDwG6ZWETLE5DaMr1U"
        ...
        while retries < max_retries:
            ...
            if response.status_code == 200:
                ...
                if token:
                    ...
                    break
            retries += 1
            time.sleep( 2** retries)  # wait for 2 seconds before retrying
            ...
            for future in tqdm(as_completed(future_to_row), total=len(future_to_row)):
                ...
                if result:
                    ...
                    if save_row % 100 == 0:   # CHANGE this PART
                        print(content['instruction'][-2:], content['context'][-2:],content['response'][-2:])
